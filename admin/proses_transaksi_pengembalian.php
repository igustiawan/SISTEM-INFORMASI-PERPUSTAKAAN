...
// }else{
    ...
    mysql_query("update tblbuku set stok=stok+$qty where id_buku='$id_buku'")or die(mysql_error());

    mysql_query("update tbltransaksi set status = '2' where id_transaksi='$id'")or die(mysql_error());
    echo"<script type='text/javascript'>
