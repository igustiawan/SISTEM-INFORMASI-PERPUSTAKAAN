...
$tgl_awal= $_POST['tgl_awal_kembali'];
$tgl_akhir= $_POST['tgl_akhir_kembali'];
...
$pdf->Cell(35,6,'Tgl Pengembalian',1,1);
 
$pdf->SetFont('Arial','',10);
$query = mysql_query("select a.id_anggota,b.nama_depan,c.judul_buku,d.nm_kategori,tgl_pengembalian from tblpengembalian a 
                    ...
                    where 
                    DATE_FORMAT(tgl_pengembalian, '%d/%m/%Y') between '$tgl_awal' and '$tgl_akhir'");
while ($row = mysql_fetch_array($query)){
    ...
    $pdf->Cell(35,6,$row['tgl_pengembalian'],1,1);
}
